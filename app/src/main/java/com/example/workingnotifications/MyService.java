...
public class MyService extends Service {
    ...
    private Notification createForegroundNotification() {
        ...
        Intent resultIntent2 = new Intent(this, NActivity2.class);
        PendingIntent resultPendingIntent2 = PendingIntent.getActivity(this, 0, resultIntent2, 0);

        Intent resultIntent3 = new Intent(this, NActivity3.class);
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentTitle("App")
                .setContentText("Do work")
                .setContentIntent(resultPendingIntent2)
                .addAction(R.mipmap.ic_launcher, "NActivity2", resultPendingIntent2)
                .addAction(R.mipmap.ic_launcher, "ANActivity3", resultPendingIntent3)
                .build();
        return notification;
